...
const STABLE_DIFFUSION_TEMPLATE = `### **System Prompt for Stable Diffusion Prompt Generation**  
...
const DALLE_3_TEMPLATE = `### **System Prompt for DALL·E 3 Prompt Assistant**  
...
const TEXT_TO_VIDEO_TEMPLATE = `### **System Prompt for Text-to-Video Prompt Generation**  
    ...
    return (
        <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mb-3">
                Quickly load a pre-made system prompt for specific tasks.
            </p>
            <div className="flex flex-wrap gap-2">
                <button
                    onClick={() => onSelectTemplate(STABLE_DIFFUSION_TEMPLATE)}
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 bg-gray-700 text-gray-200 font-medium py-2 px-4 rounded-lg hover:bg-gray-600 transition-colors duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Stable Diffusion Prompt Engineer
                </button>
                 <button
                    onClick={() => onSelectTemplate(DALLE_3_TEMPLATE)}
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 bg-gray-700 text-gray-200 font-medium py-2 px-4 rounded-lg hover:bg-gray-600 transition-colors duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    DALL·E 3 Prompt Assistant
                </button>
                <button
                    onClick={() => onSelectTemplate(TEXT_TO_VIDEO_TEMPLATE)}
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 bg-gray-700 text-gray-200 font-medium py-2 px-4 rounded-lg hover:bg-gray-600 transition-colors duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed"
                >
